...
//                    }
                    ...
                    menuItemFrame = CGRect(x: 2.0, y: 0.0, width: configuration.menuItemWidth, height: configuration.menuHeight)
                } else if configuration.centerMenuItems && index == 1.0{
                    menuItemFrame = CGRect(x: configuration.menuItemWidth * 0.98 - 5.0 + startingMenuMargin, y: 0.0, width: configuration.menuItemWidth, height: configuration.menuHeight)
                } else if configuration.centerMenuItems && index == 2.0{
                  menuItemFrame = CGRect(x: configuration.menuItemWidth * 1.98 - 5.0 + startingMenuMargin, y: 0.0, width: configuration.menuItemWidth, height: configuration.menuHeight)
                } else if configuration.centerMenuItems && index == 3.0{
                  menuItemFrame = CGRect(x: configuration.menuItemWidth * 2.77 - 5.0 + startingMenuMargin, y: 0.0, width: configuration.menuItemWidth, height: configuration.menuHeight)
              }
