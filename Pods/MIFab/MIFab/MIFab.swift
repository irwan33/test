...
public class MIFab {
    ...
    public struct Config {
        ...
        public var buttonPadding = CGSize(width: 15, height: 15)
        public var buttonSize: CGFloat = 65
        
        public var buttonImage: UIImage?
      
        public var buttonBackgroundColor = UIColor.orange
        public var buttonTintColor = UIColor.white
        public var tittleButton: String?
        ...
        public var optionIconSize: CGFloat = 50
    ...
    fileprivate func setupButton() {
        ...
        fabButton.button.setImage(config.buttonImage, for: UIControlState.normal)
        fabButton.button.imageView?.contentMode = UIViewContentMode.scaleAspectFill
        fabButton.button.imageView?.clipsToBounds = false
